...
export default function WorshipperLoginPage() {
  ...
  const demoAccounts = [
    { name: 'Comfort Oladayo', role: 'Pilgrim (Approved)', email: 'comfort@redemption.city', password: 'demo123' },
  ];
        ...
        >
          <div className="backdrop-blur-xl bg-gradient-to-br from-[#0047AB]/80 to-[#003580]/80 rounded-3xl p-12 border border-white/20 shadow-2xl">
            <motion.div
              ...
              className="mb-12"
            >
              <div className="text-sm font-semibold text-blue-100/70 mb-2">NEXUM WORSHIPPER PORTAL</div>
              <h1 className="text-5xl font-bold text-white mb-3">Pilgrim Hub</h1>
              <p className="text-blue-100/80 text-base">Book accommodation & stay connected</p>
            </motion.div>
            ...
            >
              {[
                'Browse & book approved properties',
                'Report incidents instantly',
                'Receive safety alerts',
                '24/7 guidance access',
              ].map((feature, i) => (
                <motion.div
                  key={feature}
            ...
            <motion.div
              ...
              transition={{ delay: 1 }}
            >
              <p className="text-sm text-blue-100/70">One platform connecting worshippers to camp services and safety</p>
            </motion.div>
          </div>
        </motion.div>
          ...
          >
            ...
            <motion.div className="mb-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
              ...
              <p className="text-slate-600">
                {isSignUp ? 'Join the Pilgrim Hub' : 'Sign in to your Pilgrim Hub account'}
              </p>
            </motion.div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {isSignUp ? <RegisterForm role="worshipper" /> : <LoginForm role="worshipper" callbackUrl="/worshipper/bookings" />}
              </motion.div>
            </AnimatePresence>
