      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-blue-300 text-xs hidden sm:block">· Redemption City</span>
          </Link>

          {/* Nav links */}
          <nav className="flex items-center gap-1">
            <Link href="/properties"
              className="text-sm text-blue-100 hover:text-white px-3 py-1.5 rounded hover:bg-white/10 transition-colors">
              Browse Properties
            </Link>
            ...
            {session ? (
              <>
                ...
                <div className="flex items-center gap-2 ml-3 pl-3 border-l border-white/20">
                  <div className="text-right">
                    ...
                    <div className="text-[10px] text-blue-300">{roleName(session.user.role)}</div>
                  </div>
              ...
              <div className="flex items-center gap-2 ml-3">
                ...
                <Link href="/register">
                  <Button size="sm" className="bg-white text-nexum-navy hover:bg-blue-50">
                    Register
                  </Button>
                </Link>
              </div>
